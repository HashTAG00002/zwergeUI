#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
#           This file was copied from src/transformers/models/qwen2_5_vl/modeling_qwen2_5_vl.py, 
#       which was automatically generated from src/transformers/models/qwen2_5_vl/modular_qwen2_5_vl.py.
#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
...
class Qwen2_5_VLAttention(nn.Module):
    ...
    def forward(
        ...
        response_start_idx: int = 0, # not used for flash-attn & sdpa
        ...
        query_states = query_states[:,:,response_start_idx:,:]
        q_len = query_states.shape[-2]
        attn_weights = torch.matmul(query_states, key_states.transpose(2, 3)) / math.sqrt(self.head_dim)

        if attention_mask is not None:  # no matter the length, we just slice it
            causal_mask = attention_mask[:, :, response_start_idx:, : key_states.shape[-2]]
        ...
        # for residual add when self_attn returns
        full_attn_output = torch.zeros_like(hidden_states)
        full_attn_output[:, response_start_idx:, :] = attn_output
...
class Qwen2_5_VLModel(Qwen2_5_VLPreTrainedModel):
    ...
    def forward(
        ...
        causal_mask = self._update_causal_mask(
            attention_mask, inputs_embeds, cache_position, past_key_values, output_attentions, replace_eager=False
        )

        last_causal_mask = self._update_causal_mask(
            attention_mask, inputs_embeds, cache_position, past_key_values, output_attentions, replace_eager=True
        )
        ...
        for layer_i, decoder_layer in enumerate(self.layers):
            ...
            if layer_i == len(self.layers) - 1:
                ...
                current_causal_mask = last_causal_mask
            else:
    ...
    def _update_causal_mask(
        ...
        output_attentions: bool = False,
        replace_eager: bool = False,
    ):
        if not replace_eager:
            current_attn_implementation = self.config._attn_implementation
        else:
            current_attn_implementation = "eager"
        if current_attn_implementation == "flash_attention_2":
        ...
        if (
            current_attn_implementation == "sdpa"
