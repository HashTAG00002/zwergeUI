...
export WANDB_RUN_NAME="zwerge-A4-gaussian_cos_meta_L18-25-$(date +%Y%m%d-%H%M%S)"
...
OUTPUT_DIR="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-mt-ocr/yangwenkui03/.hdd/ckpt/zwerge/uitars7b_grounding50k_A4-gaussian_cos_meta_L18-25_${RUN_TIMESTAMP}"
mkdir -p "${OUTPUT_DIR}"
