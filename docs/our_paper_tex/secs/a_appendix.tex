...
\begin{itemize}
  ...
  \item \textbf{Fusion consistently outperforms the best single layer.}
  The fusion dotted line lies above the peak of the per-layer curve in nearly all panels.
  This confirms that the learned cross-layer aggregation in \textsc{ContextLoRACosMetaFusion} recovers information not captured by any individual probe.
...
\begin{figure*}[p]
  ...
  \caption{
    ...
    The fusion head (dotted) consistently exceeds the best single-layer probe, confirming the benefit of learned cross-layer aggregation.
  }
